;;; test-util.el --- test supporting functions for org-commentary -*- lexical-binding: t -*-
  ...
  (describe "Parse custom drawers"
    ...
    (it "should return the list of custom drawers if the buffer contains single `#DRAWERS' keyword"
      (with-temp-buffer
        ...
        (expect (org-commentary--parse-custom-drawers) :to-equal '("CUSTOM" "DRAWER"))))
...
Some text.")
        (expect (org-commentary--parse-custom-drawers)
